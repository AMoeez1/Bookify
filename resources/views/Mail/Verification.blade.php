                    ...
                    <tr>
                        <td style="padding: 20px; text-align: left; color: #555;">
                            ...
                            <form action="" method="POST">
                                @csrf
                                <a href="{{url('/author/verify')}}"
                                    style="background-color: #6c757d; text-decoration:none; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">Verify
                                    Email</a>
                            </form>
