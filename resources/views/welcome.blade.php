...
@section('content')
<!-- Hero Section -->
<section class="bg-center h-72 md:h-96" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdxLtKhAukpF1QK__ZI5P-X3Smxf7dDyjNJg&s');">
    <div class="text-center content-center h-full bg-black bg-opacity-50">
...
<div class="container mx-auto py-6">
    <div class="flex justify-center">
        <input type="text" placeholder="Search for your next great read..." class="border border-gray-300 rounded-lg p-2 w-1/2 md:w-1/3" />
    </div>
</div>
